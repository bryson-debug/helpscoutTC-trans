...
function baseStyles() {
  return `
    <style>
      ...
      .tc-link-btn { display: inline-block; margin-top: 10px; padding: 6px 12px; background: #314ddb; color: #fff !important; text-decoration: none; border-radius: 4px; font-size: 13px; font-weight: 600; }
