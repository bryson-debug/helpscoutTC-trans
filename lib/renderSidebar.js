...
function baseStyles() {
  return `
    <style>
      ...
      .tc-group-header { display: flex; align-items: center; gap: 6px; width: 100%; background: none; border: none; padding: 0; margin: 12px 0 6px; cursor: pointer; text-align: left; }
