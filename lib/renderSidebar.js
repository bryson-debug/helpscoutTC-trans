...
function renderProfileLink(customerId, email) {
  const template = process.env.THRIVECART_CUSTOMER_URL_TEMPLATE || 'https://thrivecart.com/customer/{customerId}';
  const href = template
