...
function baseStyles() {
  return `
    <style>
      ...
      .tc-link-btn { display: inline-block; margin-top: 10px; padding: 6px 12px; background: #1b5088; color: #fff !important; text-decoration: none; border-radius: 4px; font-size: 12px; font-weight: 600; }
      .tc-link-btn:hover { background: #143c66; }
